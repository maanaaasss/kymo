    ...
    <div className="w-full max-w-[560px] mx-auto mt-[var(--space-6)] mb-[var(--space-4)] px-2">
      <div className="grid grid-cols-2 gap-4 justify-items-center min-[600px]:flex min-[600px]:flex-row min-[600px]:-space-x-[14px] min-[600px]:justify-center min-[600px]:gap-0">
        ...
        >
          ...
          {/* Title */}
          <h3 className="text-[14px] font-sans font-medium text-[#F3F2EE] leading-tight mt-[12px]">
            Full video
          </h3>

          {/* Description */}
          <p className="text-[10px] text-[#9A9AA2]/85 leading-snug mt-[8px] line-clamp-2">
        ...
        >
          {/* Visual Area */}
          <div className="h-[80px] w-full rounded-[8px] bg-[#26342F] relative shrink-0 overflow-hidden">
            <svg viewBox="0 0 132 80" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
              ...
              <rect x="62" y="16" width="3" height="48" rx="1.5" fill="#E2562B"/>
              <rect x="68" y="10" width="3" height="60" rx="1.5" fill="#E2562B"/>
              <rect x="74" y="15" width="3" height="50" rx="1.5" fill="#E2562B"/>
        ...
        >
          ...
          <div className="h-[80px] w-full rounded-[8px] bg-[#3A2E2A] relative overflow-hidden shrink-0">
            ...
            <svg viewBox="0 0 132 80" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
              ...
              {/* Sun */}
              <circle cx="50" cy="31" r="3" fill="#E2562B" />
              {/* Mountain 1 */}
